...
x = eval(input("Welk enzym gebruik je? "))
#Vraagt naar enzym

if x in sequentie:
    print("Dit zit in de sequentie")
#Als de input in de sequentie zit, print dat dit.
else:
    print("Dit zit niet in de sequentie")
#Als de input niet in de sequentie zit, print dan dit
